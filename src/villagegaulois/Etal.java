...
public class Etal {
	...
	public String libererEtal() {
		if (!etalOccupe) {
			throw new NullPointerException("Cet étal n'a pas été occupé.");
		}
		...
		StringBuilder chaine = new StringBuilder("Le vendeur " + temp + " quitte son étal, ");
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) {
		...
		if (quantiteAcheter < 1) {
			throw new IllegalArgumentException("La quantité doit être positive et supérieure à 0.");
		}
		if (!etalOccupe) {
			throw new IllegalStateException("Cet étal n'a pas été occupé.");
		}
